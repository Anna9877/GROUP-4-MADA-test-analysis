...
@fig-scatterplot shows a scatterplot figure produced by one of the R scripts.

```{r}
#| label: fig-scatterplot
#| fig-cap: "Age vs. Weight"
#| echo: FALSE
knitr::include_graphics(here("results","scatterplot_weight_and_age.png"))
```
@fig-boxplot shows a boxplot produced by one of the R scripts.
```{r}
#| label: fig-boxplot
#| fig-cap: "Height by Handedness"
#| echo: FALSE
knitr::include_graphics(here("results","boxplot_handedness_and_height.png"))
```
